...
#ifndef VirtualWirem_h
#define VirtualWirem_h
...
extern uint8_t tx_success;
extern uint8_t tx_msg_buf[VW_MAX_MESSAGE_LEN];
extern uint8_t tx_msg_buflen;
...
extern "C"
{
    ...
    extern void init1(const unsigned int periodHz,void (*userCallBack)());
    ...
    extern uint8_t vw_get_decoded_msg(uint8_t* msg_buf, uint8_t* msg_buflen);
	extern uint8_t tx_coded_msg(uint8_t* buf, uint8_t len, uint8_t rec_add, uint8_t ack);
